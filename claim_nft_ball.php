    ...
    <div class="container position-relative">
            ...
            <div class="row mb-5 align-items-center">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="input-address ml-auto">
                        <p class="mb-0 text-truncate text-white" id="wallet_address">
                            0xef658fc96514c1137d5f21e0b707f047455ead25</p>
                        <button type="button" class="btn ml-4 btn-copy d-block p-0"
        ...
        <div class="my-inventory" id="accordion">
            <div class="row position-relative">
                <div class="order-1 order-md-1 col-md-4 col-sm-6 col-xs-12 mb-3" id="headingOne">
                    <div class="card-nfts card" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
                ...
                <div class="order-3 order-md-2 col-md-4 col-sm-6 col-xs-12 mb-3">
                    <div class="card-nfts card" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false"
                ...
                <div class="order-5 order-md-3 col-md-4 col-sm-6 col-xs-12 mb-3">
                    <div class="card-nfts card" data-toggle="collapse" data-target="#collapseThree"
                ...
                <div class="order-7 order-md-5 col-md-4 col-sm-6 col-xs-12 mb-3">
                    <div class="card-nfts card" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true"
                        aria-controls="collapseOne">
                        <img class="card-img-top" src="./dist/images/nfts_1.png" alt="Card image cap">
                        <div class="card-body p-0 mt-3">
                            <h5 class="card-title mb-0">Nfts_1</h5>
                ...
                <div class="order-9 order-md-6 col-md-4 col-sm-6 col-xs-12 mb-3">
                    <div class="card-nfts card" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false"
                        aria-controls="collapseTwo">
                        <img class="card-img-top" src="./dist/images/nfts_2.jpeg" alt="Card image cap">
                        <div class="card-body p-0 mt-3">
                            <h5 class="card-title mb-0">Nfts_2</h5>
                ...
                <div class="order-11 order-md-7 col-md-4 col-sm-6 col-xs-12 mb-3">
                    <div class="card-nfts card" data-toggle="collapse" data-target="#collapseSix"
                        aria-expanded="false" aria-controls="collapseThree">
                        <img class="card-img-top" src="./dist/images/nfts_3.jpeg" alt="Card image cap">
                        <div class="card-body p-0 mt-3">
                            <h5 class="card-title mb-0">Nfts_3</h5>
